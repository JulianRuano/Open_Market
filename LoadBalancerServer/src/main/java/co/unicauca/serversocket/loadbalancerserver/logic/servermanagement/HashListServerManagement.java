...
public class HashListServerManagement implements IServerManagement {
    ...
    public HashListServerManagement(){
        ...
        serverList.put(0, new ServerInfo("localhost",5002));
        serverList.put(1, new ServerInfo("localhost",5003)); 
        serverList.put(2, new ServerInfo("localhost",5004)); 
        serverList.put(3, new ServerInfo("localhost",5005)); 
        serverList.put(3, new ServerInfo("localhost",5006)); 
    }
